...
/** True when the required public env vars are set and contain valid values (not empty or default placeholders). */
export function isSupabaseConfigured(): boolean {
  ...
  // Basic URL validation to prevent crashes from placeholder or invalid URLs
